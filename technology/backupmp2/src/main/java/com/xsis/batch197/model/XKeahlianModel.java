...
public class XKeahlianModel {
	...
	@ManyToOne
	@JoinColumn(name="skill_level_id", foreignKey = @ForeignKey(name = "fk_keahlian_level_skill"), updatable = false, insertable = false )
	private XSkillLevelModel skill;
	
	@ManyToOne
	@JoinColumn(name="x_biodata", foreignKey = @ForeignKey(name="fk_biodata"), updatable = false, insertable = false )
